...
<script>
const COLS = [
    { key:'todo',          label:'Backlog',                        color:'#353c4a',       textColor:'var(--text-muted)' },
    { key:'in_progress',   label:'In Progress',                    color:'var(--blue)',   textColor:'var(--blue)'       },
    { key:'ai_completed',  label:'AI Completed/Developer Review',  color:'var(--purple)', textColor:'var(--purple)'     },
    { key:'qa',            label:'QA',                             color:'var(--amber)',  textColor:'var(--amber)'      },
